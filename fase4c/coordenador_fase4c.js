...
if (!fs.existsSync(phaseLogDir)) fs.mkdirSync(phaseLogDir, { recursive: true });
...
function initializeBinance() {
  ...
  const workerExecBinance = new Worker(path.resolve(__dirname, "../workerExecBinance.js"), {
    workerData: {
...
function initializeOKX() {
  ...
  const workerExecOKX = new Worker(path.resolve(__dirname, "../workerExecOKX.js"), {
    workerData: {
...
function initializeBybit() {
  ...
  const workerExecBybit = new Worker(path.resolve(__dirname, "../workerExecBybit.js"), {
    workerData: {
